...
Please use whatever technology and techniques you feel are applicable to solve the problem. We strongly suggest that you approach this exercise as if this code was part of a larger system. The end result should be representative of your abilities and style.
